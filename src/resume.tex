...
\name{Chen Ting}{Huang (Tim)}
\position{Senior Product Developer{\enskip\cdotp\enskip}Software Engineer}

\mobile{(+886) 930-578-300}
\email{timhuang304@gmail.com}
%\dateofbirth{January 1st, 1970}
%\homepage{www.posquit0.com}
\github{AsheeHuang}
\linkedin{huangchenting}
% \gitlab{gitlab-id}
